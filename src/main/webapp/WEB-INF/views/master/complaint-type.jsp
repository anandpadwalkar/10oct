...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<button id="add-complaint-btn"
						...
						class="btn btn-success btn-sm" data-toggle="tooltip"  data-original-title="Add New Complaint">
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
			...
			style="display: none;">
			<form action="../master/delete-complaint" method="post" id="delete-form">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">Delete Complaint Type ?</div>
...
.error {
	...
	$(document).ready(function(){
		...
		$("#add-complaint-btn").click(function(){
			ajaxProperties.url = "../master/add-complaint";
		...
		if("${operation}" == "add"){
			$("#popup").css('display', '');
			$("#add-update-form").prop("action", "../master/add-complaint");
			$("#add-btn").val('Add');
		}
		
		if("${operation}" == "edit"){
			$("#popup").css('display', '');
			$("#add-update-form").prop("action", "../master/update-complaint");
			$("#add-btn").val('Update');
		}
	...
	function updateComplaint(id, complaintTypeName, deptId){
		...
		ajaxProperties.url = "../master/update-complaint";
	    ajaxProperties.formType = "complaint-type";
